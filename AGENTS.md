...
- The repository root of the current checkout is the canonical working directory.
...
- Current runtime code, current user direction, and freshly passing tests are the implementation authority.
