...
class Phase12QaReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_PREPARE = "blue.bluehair.naiblue.transfer.qa.PREPARE"
        const val ACTION_CONFIRM = "blue.bluehair.naiblue.transfer.qa.CONFIRM"
        const val ACTION_RUN = "blue.bluehair.naiblue.transfer.qa.RUN"
        const val ACTION_STATUS = "blue.bluehair.naiblue.transfer.qa.STATUS"
