...
object TransferNotifications {
    const val ACTION_PAUSE = "blue.bluehair.naiblue.transfer.PAUSE"
    const val ACTION_RESUME = "blue.bluehair.naiblue.transfer.RESUME"
    const val ACTION_RETRY = "blue.bluehair.naiblue.transfer.RETRY"
    const val ACTION_CANCEL = "blue.bluehair.naiblue.transfer.CANCEL"
    const val EXTRA_TRANSFER_ID = "transfer_id"
    private const val CHANNEL_ID = "nai_blue_large_transfers"
