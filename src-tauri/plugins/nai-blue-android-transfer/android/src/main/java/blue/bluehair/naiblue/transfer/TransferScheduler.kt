...
class TransferScheduler(private val context: Context) {
    ...
    companion object {
        const val EXTRA_TRANSFER_ID = "nai_blue_transfer_id"
        private const val WORK_TAG = "nai_blue_android_transfer"

        fun workName(transferId: String): String = "nai-blue-transfer-$transferId"
