"""Danbooru tag verification helpers for NAI Blue's Tauri Python sidecars.
...
USER_AGENT = "nai-blue-danbooru-tag-verify/1.0"
CACHE_SIZE = 4096
...
class TagVerifyResult:
    """Verification result consumed by the NAI Blue GUI integration layer."""
