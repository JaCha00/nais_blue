<#
.SYNOPSIS
Tracks a connected Android NAI Blue process for idle busy-loop and growth signals.
...
the installed app through adb. Keep NAI Blue visible and do not generate images
...
param(
    ...
    [string]$Package = 'blue.bluehair.naiblue',
