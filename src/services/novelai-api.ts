...
import { buildNais2Params, shouldEmbedNais2Params, type MetadataMode } from '@/lib/generation-metadata'
...
export async function generateImage(
    ...
    try {
        ...
        const taggedBase64 = shouldEmbedNais2Params(params.metadataMode)
...
export async function generateImageStream(
    ...
    try {
        ...
        if (finalImageData) {
            const taggedFinal = shouldEmbedNais2Params(params.metadataMode)
                ? embedNais2Params(finalImageData, buildNais2Params(params))
                : finalImageData
            return {
                success: true,
