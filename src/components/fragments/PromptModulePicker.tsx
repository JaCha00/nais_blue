...
import { FileText, FolderOpen, LoaderCircle, Search } from 'lucide-react'
                    ...
                    <section className="flex min-h-0 flex-col border-y border-border/70" aria-live="polite" aria-label={t('guided.promptModules.linesLabel', '선택할 프롬프트 문장')}>
                        {selectedFile !== null && (
                            <div className="border-b border-border/70 px-3 py-2">
                                <p className="break-words text-sm font-medium text-muted-foreground [overflow-wrap:anywhere]">
